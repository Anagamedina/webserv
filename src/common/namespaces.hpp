...
namespace config
{
	...
	namespace errors
	{
		...
		static const std::string invalid_redirect_code =
		...
		static const std::string invalid_max_num_args_upload_directive =
			"Too many arguments in 'upload_store' directive";
		...
		static const std::string invalid_port_range =
